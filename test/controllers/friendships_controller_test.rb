...
class FriendshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post friendships_url, params: { friendship: { create: @friendship.create, destroy: @friendship.destroy, friend: @friendship.friend, user_id: @friendship.user_id } }
    end
  ...
  test "should update friendship" do
    patch friendship_url(@friendship), params: { friendship: { create: @friendship.create, destroy: @friendship.destroy, friend: @friendship.friend, user_id: @friendship.user_id } }
